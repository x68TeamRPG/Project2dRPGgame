...
public class TreasureController : MonoBehaviour
{
    ...
    private int flag;
    public int TreasureNumber;//宝箱の番号
    ...
    void Start()
    {
        ...
        flag = PlayerPrefs.GetInt("treasure" + TreasureNumber, 0); // デフォルト値は0
        Debug.Log(flag + "と" + TreasureNumber);
        if (flag == 1)
        {
    ...
    void OnTriggerStay2D(Collider2D other)
    {
        ...
        if (other.gameObject.CompareTag("Player") && (Input.GetKey(KeyCode.Return) || Input.GetKey(KeyCode.Z)) && flag == 0)
        {
            ...
            PlayerPrefs.SetInt("treasure" + TreasureNumber, 1);
        }
    }
}
